...
public class EmployeeService {
	...
	public Map<String, ?> insertEmployeeWithOutput(String empName, Integer empSalary, Integer empDept) {
		return employeeRepository.insertEmployeeWithOutput(empName, empSalary, empDept);
	}
